...
// mongoose
//   .connect(
//     "mongodb+srv://atzgg132:ABhatt%40312!@cluster0.bpj5plp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
//     {
...
app.get("/attendanceToday/:date", async (req, res) => {
  try {
    ...
    if (!attendanceRecord) {
      return res
        .status(404)
        .send("Attendance data not found for the specified date.");
    }
...
// Add this line immediately after the mongoose.connect call
